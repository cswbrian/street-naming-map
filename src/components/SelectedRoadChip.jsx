    ...
    <>
      <div className="selected-road-chip-content">
        ...
        <dl className="selected-road-chip-meta">
          ...
          <div className="selected-road-chip-row">
            <dt className="selected-road-chip-label">{labels.colNotice}</dt>
            <dd className="selected-road-chip-value">
              {safeNoticeUrl ? (
                <a
                  className="selected-road-chip-notice"
                  href={safeNoticeUrl}
                  target="_blank"
          ...
          <div className="selected-road-chip-row">
            ...
            <dd className="selected-road-chip-value">
              {selectedRoadInfo.sourceBadge ? (
                <span
                  className={`selected-road-chip-source pending-source-badge pending-source-${selectedRoadInfo.sourceBadge.kind}`}
                  title={selectedRoadInfo.sourceBadge.hint}
                >
                  {selectedRoadInfo.sourceBadge.label}
                </span>
              ) : (
                <span className="selected-road-chip-empty">—</span>
              )}
